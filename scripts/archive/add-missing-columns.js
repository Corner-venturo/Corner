    ...
    const columns = [
      {
        ...
        update: 'UPDATE quotes SET number_of_people = COALESCE(adult_count, 0) + COALESCE(child_count, 0) + COALESCE(infant_count, 0)'
      },
      {
        table: 'quotes',
        column: 'customer_id',
      ...
      },
      {
        ...
        column: 'name_en',
        definition: 'TEXT',
        update: 'UPDATE members SET name_en = english_name WHERE name_en IS NULL AND english_name IS NOT NULL'
      },
      {
        table: 'tours',
      ...
      },
      {
        ...
        column: 'order_number',
        definition: 'TEXT',
        update: 'UPDATE orders SET order_number = code WHERE order_number IS NULL OR order_number = \'\''
      }
    ];

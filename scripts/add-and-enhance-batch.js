...
const attractions = [
  // === 東京重要景點 ===
  {
    ...
    type: 'landmark',
    description:
      '東京最大的公園之一，佔地約53萬平方公尺，園內有東京國立博物館、國立科學博物館、上野動物園等眾多文化設施。春季約1200棵櫻花樹盛開，是東京最知名的賞櫻名所。不忍池的蓮花與划船體驗也是人氣行程。',
    ...
    notes:
      '上野動物園大熊貓「香香」超人氣，建議平日前往。博物館週一休館。不忍池划船約700日圓/30分鐘。',
  },
  {
    city: '東京',
    name: '東京車站',
    type: 'landmark',
    description:
      '1914年開業的紅磚建築，歷經戰爭損毀後於2012年完成復原。丸之內站舍的圓頂內部雕刻精美，車站內的東京站一番街匯集動漫商品、拉麵街、甜點街。地下街「八重洲地下城」是購物美食的寶庫。',
    duration_minutes: 90,
    ...
    notes:
      '東京站限定伴手禮必買「東京芭娜娜」。一番街的動漫周邊商品比秋葉原便宜。晚上車站點燈非常美麗。',
  },
  {
    city: '東京',
    name: '秋葉原電器街',
    type: 'shopping',
    description:
      '全球最大的電器與動漫文化聖地。從傳統電器街發展成動漫、遊戲、偶像文化的中心。有數百家動漫商品店、女僕咖啡廳、扭蛋專門店。Radio會館、虎之穴、Animate是代表性商店。',
    duration_minutes: 180,
    ...
    notes:
      'Radio會館8層樓都是動漫商品。女僕咖啡廳建議選有英文菜單的店。週日中央通行人天國12:00-18:00。',
  },
  {
    city: '東京',
    name: '原宿竹下通',
    type: 'shopping',
    description:
      '全長約400公尺的青年時尚發源地，兩側林立超過100家流行服飾店、可愛雜貨店、甜點店。可麗餅是竹下通的代表美食，「馬里昂可麗餅」是元祖名店。裏原宿則是潮牌集中地。',
    duration_minutes: 90,
  ...
  },
  {
    ...
    type: 'landmark',
    description:
      '2003年開業的大型複合都市開發，包含森大樓52樓的東京城市觀景台（海拔250m）、森美術館、豪華購物商場。毛利庭園是江戶時代大名庭園遺跡。夜景被評為東京最美之一。',
  ...
  },
  {
    ...
    type: 'shopping',
    description:
      '日本最高級的商業街區，有「日本第五大道」之稱。百年老店與國際精品林立，GINZA SIX、銀座三越、和光等百貨是代表。中央通週末12:00-18:00成為步行者天國。',
    duration_minutes: 180,
  ...
  },
  {
    ...
    type: 'shopping',
    description:
      '東京最時尚的住宅區「代官山」的地標，被譽為世界最美書店之一。三棟建築以通道連接，24小時營業。2樓星巴克可邊看書邊喝咖啡。書籍按主題而非作者分類，設計感十足。',
  ...
  },
  {
    ...
    type: 'theme_park',
    description:
      '1983年開幕的亞洲第一座迪士尼樂園，佔地約51萬平方公尺。分為7大主題區域：世界市集、冒險樂園、西部樂園、動物天地、夢幻樂園、卡通城、明日樂園。經典設施包括飛濺山、巨雷山、幽靈公館等。',
    ...
    notes:
      '門票約7900-9400日圓。使用Disney Premier Access可快速通關人氣設施。平日人較少，避開日本長假。',
  },
  {
    city: '東京',
    name: '東京迪士尼海洋',
    type: 'theme_park',
    description:
      '2001年開幕的全球唯一海洋主題迪士尼樂園，以航海冒險為概念設計7大主題區。刺激度高於陸園，達菲熊家族是海洋專屬角色。必玩：玩具總動員瘋狂遊戲屋、驚魂古塔、地心探險。',
    duration_minutes: 600,
    opening_hours: '8:00-21:00（依季節調整）',
    tags: [
      '迪士尼海洋',
  ...
  },
  {
    ...
    type: 'landmark',
    description:
      '東京灣人工島，集購物、娛樂、觀光於一身。彩虹大橋、18公尺高獨角獸鋼彈立像、富士電視台球體展望室是地標。DiverCity、AQUA CITY、維納斯城堡是代表性購物中心。',
  ...
  },
  {
    ...
    type: 'shopping',
    description:
      '連接明治神宮到青山的林蔭大道，全長約1公里。兩側是國際精品旗艦店與設計師品牌，建築本身就是藝術品。Omotesando Hills由安藤忠雄設計，表參道之丘是代表性商場。',
    duration_minutes: 120,
    opening_hours: '各店約11:00-20:00',
    tags: [
      '林蔭大道',
  ...
  // === 北海道重要景點 ===
  {
    ...
    type: 'landmark',
    description:
      '1923年完工的運河，全長約1140公尺。沿岸的石造倉庫群改建成餐廳、商店、博物館。每到黃昏點亮63盞煤氣燈，冬季雪中的運河更是夢幻絕景。',
    duration_minutes: 120,
    opening_hours: '全天開放，煤氣燈點亮至24:00',
    tags: ['運河夜景', '煤氣燈', '石造倉庫', '人力車', '玻璃工藝', '音樂盒館', '浪漫景點', '雪景'],
    notes:
      '每年2月小樽雪燈之路是年度盛事。建議傍晚前往看日落與點燈。LeTAO雙層起司蛋糕是必買伴手禮。',
  },
  {
    city: '函館',
    name: '函館山夜景',
    type: 'landmark',
    description:
      '海拔334公尺，從山頂可俯瞰函館市區呈扇形分佈於兩個海灣之間的獨特地形。夜景與香港維多利亞港、那不勒斯並稱「世界三大夜景」。搭乘纜車3分鐘即可登頂。',
    duration_minutes: 90,
  ...
  },
  {
    ...
    type: 'theme_park',
    description:
      '日本最北端的動物園，以「行動展示」革命性展示方式聞名世界。可以看到企鵝在頭頂游泳、北極熊跳水、海豹穿過透明管道。冬季的「企鵝散步」是招牌活動。',
  ...
  },
  {
    ...
    type: 'nature',
    description:
      '北海道夏季代表風景，每年7月中旬至8月上旬薰衣草盛開。富田農場是最知名的免費景點，彩虹花田由7種不同顏色花卉組成。薰衣草冰淇淋、精油是人氣商品。',
    duration_minutes: 120,
  ...
  },
  {
    ...
    type: 'nature',
    description:
      '因Apple選為macOS桌布而聞名世界的神秘藍色池塘。池水因含有氫氧化鋁而呈現夢幻的青藍色，枯木倒映水中更添神秘感。冬季夜間點燈的雪景更是絕美。',
    duration_minutes: 60,
  ...
  },
  {
    ...
    type: 'landmark',
    description:
      '札幌市中心長約1.5公里的帶狀公園，是札幌雪祭、啤酒節等大型活動的主要會場。公園內有電視塔、噴水池、花壇，四季都有不同風景。',
    duration_minutes: 60,
    opening_hours: '全天開放',
    tags: [
      '雪祭會場',
  ...
  },
  {
    ...
    type: 'temple',
    description:
      '北海道最大的神社，創建於1869年明治天皇北海道開拓時期。境內有15萬棵原始森林，春季約1400棵櫻花與梅花同時綻放。是祈求事業、良緣的人氣神社。',
    duration_minutes: 60,
  ...
  // === 沖繩重要景點 ===
  {
    ...
    type: 'theme_park',
    description:
      '沖繩最具代表性的景點，擁有世界最大的壓克力觀景窗「黑潮之海」（長35m x 高10m x 深27m）。館內飼養多隻鯨鯊與鬼蝠魟，是全球少數能同時展示兩種巨型魚類的水族館。',
    duration_minutes: 240,
  ...
  },
  {
    ...
    type: 'landmark',
    description:
      '琉球王國500年歷史的象徵，世界文化遺產。2019年大火燒毀正殿後正在重建中，預計2026年完工。城牆、石門、守禮門等遺構仍可參觀，展示琉球獨特的文化融合。',
    duration_minutes: 120,
  ...
  },
  {
    ...
    type: 'shopping',
    description:
      '那霸市最熱鬧的購物街，全長約1.6公里，有「奇蹟的一英里」之稱。戰後從廢墟快速復興的象徵。沖繩伴手禮、琉球玻璃、泡盛酒、海鹽、沖繩料理餐廳應有盡有。',
    duration_minutes: 150,
    opening_hours: '約10:00-22:00',
    tags: ['購物街', '伴手禮', '泡盛酒', '沖繩料理', '牧志市場', '琉球玻璃', '紅芋塔', '夜生活'],
    notes:
      '牧志公設市場2樓可代客料理海鮮。週日12:00-18:00是行人步行區。「御菓子御殿」紅芋塔是人氣伴手禮。',
  },
  {
    city: '那霸',
    name: '波上宮',
    type: 'temple',
    description:
      '沖繩最具代表性的神社，創建於琉球王國時代。建於懸崖之上俯瞰東海，是祈求航海安全、生意興隆的聖地。旁邊的波之上海灘是那霸市區唯一的海灘。',
    duration_minutes: 45,
    opening_hours: '自由參拜',
    tags: [
      '琉球八社',
  ...
  },
  {
    ...
    type: 'nature',
    description:
      '透過古宇利大橋連接的離島，有「戀之島」美稱。傳說這裡是沖繩版亞當與夏娃的誕生地。心形礁岩「Heart Rock」因偶像劇取景一躍成名，翡翠色海水清澈見底。',
    duration_minutes: 150,
    opening_hours: '全天開放',
    tags: [
      '戀之島',
  ...
  },
  {
    ...
    type: 'nature',
    description:
      '沖繩本島最西端的海岬，高30公尺的斷崖絕壁綿延約2公里。純白的殘波岬燈塔是地標，可登頂眺望東海。夕陽西下時的景色被譽為沖繩最美。',
    duration_minutes: 60,
  ...
  // === 更多日本重要景點 ===
  {
    ...
    type: 'temple',
    description:
      '高達11.3公尺的青銅阿彌陀佛像，建於1252年。原本安置於大佛殿內，但經多次海嘯沖毀後成為露天大佛。可進入佛像內部參觀，感受700年歷史的莊嚴。',
    duration_minutes: 60,
  ...
  },
  {
    ...
    type: 'temple',
    description:
      '創建於757年的古老神社，以蘆之湖畔的「水中鳥居」聞名。被稱為「關東總鎮守」，是祈求心願成就、良緣、事業的人氣神社。參道兩旁是高聳的杉木林。',
    duration_minutes: 60,
    opening_hours: '全天開放',
    tags: [
      '水中鳥居',
  ...
  },
  {
    ...
    type: 'nature',
    description:
      '富士山登山的起點，海拔約2300公尺。即使不登山也能搭巴士抵達，近距離感受日本第一高峰的壯觀。五合目有商店、餐廳、神社，是欣賞富士山最近距離的觀光地。',
    duration_minutes: 120,
    opening_hours: '依季節開放（7-9月全天，其他季節限時）',
    tags: ['富士山', '日本最高峰', '登山起點', '雲海', '御來光', '高山體驗', '紀念品', '神社'],
    notes:
      '7-8月開山期間人潮最多。高山反應注意慢慢走。冬季道路封閉需確認。巴士從河口湖站約50分鐘。',
  },
  {
    city: '奈良',
    name: '奈良公園',
    type: 'nature',
    description:
      '佔地約660公頃的廣大公園，棲息著約1200頭野生鹿。鹿被視為神的使者，遊客可購買鹿仙貝餵食。園內有東大寺、春日大社、興福寺等世界遺產。',
    duration_minutes: 180,
  ...
  },
  {
    ...
    type: 'temple',
    description:
      '世界遺產，擁有世界最大的木造建築「大佛殿」。殿內供奉15公尺高的盧舍那大佛，重達250噸。柱子底部有「佛鼻孔」洞穴，據說穿過可獲得智慧與幸運。',
    duration_minutes: 90,
  ...
  },
  {
    ...
    type: 'temple',
    description:
      '世界遺產，以海上大鳥居聞名於世。退潮時可走到鳥居腳下，漲潮時神社彷彿漂浮於海上。593年創建，現在的建築為1168年平清盛建造的寢殿造樣式。',
    duration_minutes: 120,
    opening_hours: '6:30-18:00（依季節調整）',
    tags: ['世界遺產', '海上鳥居', '日本三景', '潮汐變化', '寢殿造', '平清盛', '彌山', '宮島'],
    notes:
      '大鳥居目前整修中（預計2024年完工）。退潮時間查詢：約6小時一次循環。宮島口搭渡輪約10分鐘。',
  },
  {
    city: '金澤',
    name: '兼六園',
    type: 'nature',
    description:
      '日本三大名園之一，歷經加賀藩主前田家歷代共170年歲月打造。取名「兼六」意為兼具六種庭園美德：宏大、幽邃、人力、蒼古、水泉、眺望。四季皆有不同風情。',
    duration_minutes: 120,
...
async function addAndEnhanceAttractions() {
  ...
  for (const item of attractions) {
    ...
    const { error } = await supabase.from('attractions').insert(insertData)

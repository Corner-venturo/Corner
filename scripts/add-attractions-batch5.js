...
const europeAttractions = [
  ...
  {
    name: '梵蒂岡博物館',
    name_en: 'Vatican Museums',
    description: '世界最大博物館之一',
    category: '博物館',
    type: 'heritage',
    tags: ['博物館', '藝術', '宗教'],
    city: '梵蒂岡',
  ...
  {
    name: '加泰隆尼亞廣場',
    name_en: 'Placa de Catalunya',
    description: '巴塞隆納中心廣場',
    category: '廣場',
    type: 'attraction',
    tags: ['廣場', '中心', '購物'],
    city: '巴塞隆納',
  ...
  {
    name: '哈利波特影城',
    name_en: 'Warner Bros. Studio Tour London',
    description: '哈利波特電影場景',
    category: '主題樂園',
    type: 'attraction',
    tags: ['哈利波特', '電影', '魔法'],
    city: '倫敦',
  ...
  {
    name: '牛津街',
    name_en: 'Oxford Street',
    description: '歐洲最繁忙購物街',
    category: '街道',
    type: 'shopping',
    tags: ['購物', '商店', '繁忙'],
    city: '倫敦',
...
const chinaAttractions = [
  ...
  {
    name: '國家博物館',
    name_en: 'National Museum of China',
    description: '中國最大博物館',
    category: '博物館',
    type: 'heritage',
    tags: ['博物館', '歷史', '文物'],
  ...
  {
    name: '北京路',
    name_en: 'Beijing Road',
    description: '廣州最繁華商業街',
    category: '街道',
    type: 'shopping',
    tags: ['購物', '歷史', '商業'],
    city: '廣州',
  ...
  {
    name: '六榕寺',
    name_en: 'Temple of the Six Banyan Trees',
    description: '千年古剎花塔',
    category: '寺廟',
    type: 'temple',
    tags: ['寺廟', '花塔', '佛教'],
  ...
  {
    name: '拙政園',
    name_en: "Humble Administrator's Garden",
    description: '蘇州最大園林',
    category: '庭園',
    type: 'heritage',
    tags: ['世界遺產', '園林', '蘇州'],

...
async function fixEmployeeAuth() {
  ...
  for (const emp of employees) {
    ...
    console.log(
      `${emp.employee_number} | ${emp.chinese_name} | workspace: ${ws?.name} (${ws?.code})`
    )
  ...
  const cornerEmployee = employees.find(
    e => e.chinese_name === 'William Chien' || e.email === 'william@venturo.internal'
  )

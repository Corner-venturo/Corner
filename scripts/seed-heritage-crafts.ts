...
const heritageCrafts = [
  ...
  },
  {
    ...
    included_items: ['陶土與工具', '登窯燒製費用', '2-3件完成作品', '國際運送', '窯元證書', '作品保證書'],
  ...
  },
  {
    ...
    included_items: ['絲線與金銀線', '高機使用', '完成作品（茶席墊）', '西陣織工藝證書', '工房茶點'],
  ...
  // ==================== 越南（3個）====================
  {
    ...
    included_items: ['漆液、蛋殼、金箔', '畫板與工具', '完成作品（30x40cm）', '國際運送', '藝術家簽名證書'],
  ...
  },
  {
    ...
    included_items: ['瓷坯與青花料', '工具使用', '窯燒費用', '2-3件完成作品', '國際運送', '陶瓷證書'],

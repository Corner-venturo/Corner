...
function validateRequired(data, requiredFields) {
    ...
    for (const field of requiredFields){
        if (data[field] === undefined || data[field] === null || data[field] === '') {
            errors.push("".concat(String(field), " 為必填欄位"));
        }
    }
    return errors;
}
...
class OfflineDatabase {
            ...
            request.onupgradeneeded = (event)=>{
                ...
                Object.entries(DB_CONFIG.stores).forEach((param)=>{
                    ...
                    if (!db.objectStoreNames.contains(storeName)) {
                        ...
                        console.log("✅ 建立 ObjectStore: ".concat(storeName));
                    }
                });
            };
        });
   ...
   */ async add(storeName, data) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            request.onsuccess = ()=>{
                console.log("✅ 新增資料到 ".concat(storeName, ":"), data.id);
                resolve(data);
            };
            request.onerror = ()=>{
   ...
   */ async update(storeName, data) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            request.onsuccess = ()=>{
                console.log("✅ 更新資料 ".concat(storeName, ":"), data.id);
                resolve(data);
            };
            request.onerror = ()=>{
   ...
   */ async delete(storeName, id) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            request.onsuccess = ()=>{
                console.log("✅ 刪除資料 ".concat(storeName, ":"), id);
                resolve();
            };
            request.onerror = ()=>{
   ...
   */ async addBatch(storeName, data) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            transaction.oncomplete = ()=>{
                console.log("✅ 批次新增 ".concat(data.length, " 筆資料到 ").concat(storeName));
                resolve(results);
            };
            transaction.onerror = ()=>{
   ...
   */ async clear(storeName) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            request.onsuccess = ()=>{
                console.log("✅ 清空 ".concat(storeName));
                resolve();
            };
            request.onerror = ()=>{
...
class OfflineManager {
   ...
   */ async update(storeName, id, updates) {
        ...
        if (!existing) {
            throw new Error("找不到資料: ".concat(id));
        }
        // 合併更新
        const updated = {
            ...existing,
   ...
   */ async createBatch(storeName, dataList) {
        ...
        console.log("✅ 批次建立 ".concat(records.length, " 筆資料:"), storeName);
        return records;
    }
    /**
   * 清空 Store
   ...
   */ async clearCompletedSync() {
        ...
        console.log("✅ 清空 ".concat(completed.length, " 筆已完成同步項目"));
    }
    // ===========================
    // localStorage 輔助方法
    // ===========================
   ...
   */ async hasUnsyncedData() {
    ...
    constructor(){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "localStorage", ("TURBOPACK compile-time truthy", 1) ? window.localStorage : "TURBOPACK unreachable");
    }
}
// ===========================
// 單例模式
...
"[project]/src/lib/offline/sync-engine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SyncEngine {
   ...
   */ async syncAll() {
        ...
        try {
            ...
            console.log("🔄 開始同步 ".concat(pendingItems.length, " 筆資料"));
            // 批次處理
            ...
            for (const batch of batches){
                for (const item of batch){
                    try {
                        ...
                        status.failedCount++;
                        status.errors.push("".concat(item.tableName, "/").concat(item.recordId, ": ").concat(error instanceof Error ? error.message : '未知錯誤'));
                    }
                }
            }
            // 清理已完成的同步項目
            await this.offlineManager.clearCompletedSync();
            console.log("✅ 同步完成: ".concat(status.completedCount, " 成功, ").concat(status.failedCount, " 失敗"));
            return status;
        } catch (error) {
   ...
   */ async syncItem(item) {
        ...
        try {
            ...
            const supabaseData = item.data ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$offline$2f$unified$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toSupabase"])(item.data) : null;
   ...
   */ async clearAllPending() {
        ...
        await this.offlineManager.clearCompletedSync();
        console.log("🗑️ 清空 ".concat(pendingItems.length, " 筆待同步項目"));
        return pendingItems.length;
    }
    constructor(config){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "offlineManager", (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$offline$2f$offline$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOfflineManager"])());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "config", DEFAULT_CONFIG);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "syncTimer", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isSyncing", false);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "hasSupabase", false);
        if (config) {
            this.config = {
                ...DEFAULT_CONFIG,
                ...config
...
"[project]/src/lib/offline/auto-sync-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$offline$2f$sync$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/offline/sync-engine.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
'use client';
;
;
const AutoSyncContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
    syncStatus: null,
    isOnline: true,
    triggerSync: async ()=>{},
    enableAutoSync: ()=>{},
...
function useAutoSync() {
    _s();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(AutoSyncContext);
}
_s(useAutoSync, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
function AutoSyncProvider(param) {
    let { children, enabled = true, interval = 30000 } = param;
    _s1();
    ...
    const [autoSyncEnabled, setAutoSyncEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(enabled);
    const [syncEngine] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AutoSyncProvider.useState": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$offline$2f$sync$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSyncEngine"])({
                enableAutoSync: enabled,
                syncInterval: interval
            })
    }["AutoSyncProvider.useState"]);
    // 監聽網路狀態
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AutoSyncProvider.useEffect": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            const handleOnline = {
                "AutoSyncProvider.useEffect.handleOnline": async ()=>{
            ...
            }["AutoSyncProvider.useEffect.handleOnline"];
            const handleOffline = {
                "AutoSyncProvider.useEffect.handleOffline": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AutoSyncProvider.useEffect": ()=>{
            const updateStatus = {
                "AutoSyncProvider.useEffect.updateStatus": async ()=>{
                    try {
            ...
            }["AutoSyncProvider.useEffect.updateStatus"];
            // 初始化時載入狀態
            updateStatus();
            // 每 5 秒更新一次狀態
            const statusInterval = setInterval(updateStatus, 5000);
            return ({
                "AutoSyncProvider.useEffect": ()=>clearInterval(statusInterval)
            })["AutoSyncProvider.useEffect"];
        }
    }["AutoSyncProvider.useEffect"], [
        syncEngine
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AutoSyncContext.Provider, {
        value: contextValue,
        children: children
    }, void 0, false, {
...
_s1(AutoSyncProvider, "kf2yTcNWjmMyZ10BVglVl6rfrq8=");
_c = AutoSyncProvider;
var _c;
__turbopack_context__.k.register(_c, "AutoSyncProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$offline$2f$auto$2d$sync$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/offline/auto-sync-provider.tsx [app-client] (ecmascript)");
...
function Sidebar() {
    ...
    const { syncStatus, isOnline } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$offline$2f$auto$2d$sync$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAutoSync"])();
    const pendingCount = (syncStatus === null || syncStatus === void 0 ? void 0 : syncStatus.pendingCount) || 0;
...
_s(Sidebar, "/vZ/Le0SgfFsy6kRi8ywMKKdwZc=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$offline$2f$auto$2d$sync$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAutoSync"]
    ];
});
_c = Sidebar;
var _c;
...
//# sourceMappingURL=src_3d7d191e._.js.map
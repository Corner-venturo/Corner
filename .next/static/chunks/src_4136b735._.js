...
function BoxSelector(param) {
    ...
    const formatDuration = (minutes)=>{
        if (minutes >= 60) {
            ...
            return mins > 0 ? "".concat(hours, "小時 ").concat(mins, "分鐘") : "".concat(hours, "小時");
        }
...
function WorkoutDialog(param) {
    ...
    // 刪除排程
    const handleDelete = ()=>{
        const confirmMessage = "確定要移除此訓練排程嗎？\n\n箱子：".concat(box === null || box === void 0 ? void 0 : box.name, "\n動作：").concat(boxData.equipment, "\n重量：").concat(boxData.weight, "kg x ").concat(boxData.reps, "次 x ").concat(boxData.sets, "組");
...
function BasicDialog(param) {
    ...
    // 刪除排程
    const handleDelete = ()=>{
        const confirmMessage = "確定要移除此排程嗎？\n\n箱子：".concat(box === null || box === void 0 ? void 0 : box.name, "\n時間：").concat(formatDateTime(scheduledBox.dayOfWeek, scheduledBox.startTime));
        if (!confirm(confirmMessage)) {
            return;
        }
        removeScheduledBox(scheduledBox.id);
...
function StatisticsPanel() {
    ...
    const formatTime = (minutes)=>{
        ...
        const mins = minutes % 60;
        if (hours > 0) {
            return "".concat(hours, "小時").concat(mins > 0 ? " ".concat(mins, "分鐘") : '');
        }
        return "".concat(mins, "分鐘");
    };
...
function ReviewDialog(param) {
    ...
    const getDefaultArchiveName = ()=>{
        ...
        return "".concat(year, "年第").concat(weekNumber, "週");
    };
    // 計算週數
...
function TimeboxPage() {
    ...
    const [timeInterval, setTimeInterval] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(60) // 分鐘
    ;

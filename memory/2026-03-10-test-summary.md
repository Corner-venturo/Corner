...
{
  "roles": ["admin"],
  "permissions": ["*", "todos", "payments", "requests", "visas", "calendar", "workspace", "quotes", "tours", "orders", "customers", "hr"]  // ✅ 已修復
}
```
...
const { data: employee, error: empError } = await supabaseAdmin
  ...
  .insert({
    ...
    roles: ['admin'],
    permissions: ['*', 'todos', 'payments', 'requests', 'visas', 'calendar', 'workspace', 'quotes', 'tours', 'orders', 'customers', 'hr'], // ← 新增
    is_active: true,
  })
```

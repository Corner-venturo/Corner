...
export const MANIFESTATION_NOTEBOOK_LABELS = {
  ...
  連續: '連續',
  天: '天',
  太棒了今日顯化已記錄: '太棒了！今日顯化已記錄',
  今日意念: '今日意念',
  今天我想要專注在: '今天我想要專注在...',
  感恩三件事: '感恩三件事',
  感恩: '感恩',
  我值得擁有美好的一切: '我值得擁有美好的一切...',
  保存中: '保存中...',
  完成今日顯化: '完成今日顯化',
  返回章節列表: '返回章節列表',
  第: '第',
...
export const TEMPLATE_DATA_PANEL_LABELS = {
  ...
  每日行程內容從行程表自動帶入_可在畫布上直接編輯文字: '每日行程內容從行程表自動帶入，可在畫布上直接編輯文字',
...
export const COMP_WORKSPACE_LABELS = {
  ...
  目前沒有待收款訂單: '目前沒有待收款訂單',
  確定要刪除這個代墊清單嗎_已建立的請款單不會被刪除: '確定要刪除這個代墊清單嗎？（已建立的請款單不會被刪除）',

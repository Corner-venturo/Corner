...
import { useWeekStatistics, useTodayScheduledBoxes, useWeekViewBoxes } from '../timebox-selectors'
...
describe('timebox-selectors', () => {
  ...
  describe('useWeekStatistics', () => {
    ...
    it('should ignore scheduled boxes without matching base box', () => {
      const mockBoxes = [{ id: 'box-1', name: 'Morning', type: 'basic', category: 'daily' }]
  ...
  describe('useWeekViewBoxes', () => {
    ...
    it('should return empty Map for week with no boxes', () => {
      const mockScheduledBoxes = [{ id: 's-1', boxId: 'box-1', scheduledDate: '2025-10-20T09:00' }]

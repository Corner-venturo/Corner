...
describe('accounting-selectors', () => {
  ...
  describe('useAccountBalance', () => {
    ...
    it('should return 0 for non-existent account', () => {
      const mockAccounts = [{ id: 'acc-1', name: 'Cash', balance: 10000 }]
  ...
  describe('useCategoryTotalsMap', () => {
    ...
    it('should filter transactions by date range', () => {
      const mockCategories = [{ id: 'cat-1', name: 'Transport', type: 'expense' }]
      ...
      const { result } = renderHook(() => useCategoryTotalsMap('2025-10-22', '2025-10-28'))
  ...
  describe('useMonthlyTransactions', () => {
    ...
    it('should return empty array for month with no transactions', () => {
      const mockTransactions = [{ id: 't-1', date: '2025-10-15', amount: 1000 }]

...
export const DATA_SOURCE_DEFINITIONS: DataSourceDefinition[] = [
  {
    ...
    fields: [
      ...
      { key: 'departureDate', label: '出發日期', type: 'date' },
      { key: 'returnDate', label: '返回日期', type: 'date' },
      { key: 'days', label: '天數', type: 'number' },
      { key: 'price', label: '價格', type: 'number' },
      { key: 'maxParticipants', label: '最大人數', type: 'number' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'contactPerson', label: '聯絡人', type: 'text' },
      { key: 'phone', label: '電話', type: 'text' },
      { key: 'email', label: 'Email', type: 'text' },
      { key: 'participants', label: '參加人數', type: 'number' },
      { key: 'totalAmount', label: '總金額', type: 'number' },
      { key: 'paidAmount', label: '已付金額', type: 'number' },
      { key: 'status', label: '狀態', type: 'text' },
      { key: 'salesPerson', label: '業務人員', type: 'text' },

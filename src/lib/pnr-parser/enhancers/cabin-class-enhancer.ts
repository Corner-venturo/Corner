...
const CABIN_CATEGORY_MAP: Record<string, 'Economy' | 'Premium Economy' | 'Business' | 'First'> = {
  ...
  'V': 'Economy', 'W': 'Economy', 'S': 'Economy', 'T': 'Economy', 'L': 'Economy',
  'K': 'Economy', 'N': 'Economy', 'E': 'Economy', 'G': 'Economy', 'X': 'Economy',
  'P': 'Premium Economy', 'R': 'Premium Economy', 'U': 'Premium Economy',
...
const DEFAULT_PRICE_ORDER: Record<string, number> = {
  'X': 1, 'T': 2, 'E': 3, 'N': 4, 'G': 5,
  'L': 6, 'K': 7, 'V': 8, 'W': 9, 'S': 10,
  'Q': 11, 'H': 12, 'M': 13, 'B': 14, 'Y': 15,
  'P': 16, 'R': 17, 'U': 18,
  'I': 19, 'D': 20, 'Z': 21, 'C': 22, 'J': 23,
  'A': 24, 'F': 25
}
 ...
 * 取得艙等資訊
 */
export function getCabinClassInfo(
  airlineCode: string,
  cabinCode: string
): CabinClassInfo {
 ...
 * 增強所有航段的艙等資訊
 */
export function enhanceAllSegmentsCabinClass(
  segments: FlightSegment[]
): EnhancedFlightSegment[] {

  ...
  args: {
    children: (
      <div className="p-6">
        ...
        <p className="text-sm text-gray-600">This is a card component with some content inside.</p>
      </div>
    ),
  },
}
    ...
    children: (
      <div>
        ...
        <div className="p-6">
          ...
          <p className="text-sm text-gray-600">Card with a gradient background image.</p>
        </div>
      </div>
    ),
  },

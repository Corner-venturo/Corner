      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full text-white p-5">
          ...
          <div className="flex-none pt-2">
            {clientName && (
              <p className="text-[9px] font-bold tracking-[0.15em] uppercase opacity-90 border-l-2 border-amber-500 pl-2">
                {clientName}
              </p>
            )}
          </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center gap-1">
            {country && (
              <h3 className="text-sm font-light tracking-[0.4em] uppercase mb-1">
                {country}
              </h3>
            )}
            <h1
            ...
            {/* 旅遊日期 */}
            {travelDates && (
              <div className="mt-3 inline-flex items-center gap-1.5 bg-white/10 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/20">
                <Plane size={12} />
                <span className="text-[10px] font-medium tracking-wide">{travelDates}</span>
              </div>
            )}
          </div>
          ...
          <div className="flex-none pt-3 pb-1">
            {/* 分隔線 */}
            <div className="w-full h-px bg-gradient-to-r from-transparent via-white/50 to-transparent mb-3" />

  ...
  generate: (options: ComponentGenerateOptions): CanvasElement[] => {
    ...
    return [
      ...
      } as ShapeElement,
      {
        ...
        zIndex: 1, rotation: 0, opacity: 1, locked: false, visible: true,
        content: '◆',
        style: { fontFamily: 'Noto Sans TC', fontSize: 8, fontWeight: '400', fontStyle: 'normal', color: COLORS.gold, textAlign: 'center', lineHeight: 1, letterSpacing: 0 },
      } as TextElement,
      {

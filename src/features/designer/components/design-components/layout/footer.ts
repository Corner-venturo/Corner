  ...
  generate: (options: ComponentGenerateOptions): CanvasElement[] => {
    ...
    return [
      ...
      } as ShapeElement,
      {
        ...
        style: { fontFamily: p.fontFamily, fontSize: 7, fontWeight: '400', fontStyle: 'normal', color: p.muted, textAlign: 'left', lineHeight: 1, letterSpacing: 1 },
      } as TextElement,
      {
        ...
        style: { fontFamily: p.fontFamily, fontSize: 8, fontWeight: '500', fontStyle: 'normal', color: p.accent, textAlign: 'right', lineHeight: 1, letterSpacing: 0 },
      } as TextElement,
    ]
  },
}

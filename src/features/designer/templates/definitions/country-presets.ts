...
// 中國 (CN)
// ============================================
const chinaMemoSettings: MemoSettings = {
  title: '中國旅遊小提醒',
  subtitle: 'Travel Tips',
  ...
  items: [
    ...
    // 禮儀類
    {
      ...
      title: '餐桌禮儀',
      titleZh: '用餐禮儀',
      content: '用餐時主人會不斷添菜表示熱情，稍留少許表示吃飽即可。敬酒文化盛行，可以茶代酒。',
      enabled: false,
    },
    {
      id: 'cn-etiquette-2',
      ...
      title: '公共場合',
      titleZh: '公共場合禮儀',
      content: '搭乘地鐵、高鐵時請保持安靜，勿大聲通話。部分地區禁止在公共場合吸菸。',
      enabled: false,
    },
    {
      id: 'cn-etiquette-3',
    ...
    // 航空/行李類
    {
      ...
      title: '機場報到',
      titleZh: '報到時間',
      content: '建議起飛前 2.5 ~ 3 小時抵達機場。中國機場安檢較嚴格，需預留充裕時間。',
      enabled: false,
    },
    {
      id: 'cn-flight-2',
    ...
    },
    {
      ...
      title: '人民幣',
      titleZh: '貨幣兌換',
      content: '建議在台灣銀行先換少量人民幣。入境可攜帶人民幣現金限額為 20,000 元。',
      enabled: false,
    },
  ],
  seasons: [
    {
      ...
      iconColor: '#f9a8d4',
      months: '3-5月',
      description: '氣溫回暖但早晚仍涼。北方沙塵暴季節，建議戴口罩。南方多雨，備妥雨具。',
      enabled: false,
    },
    {
      season: 'summer',
      ...
      iconColor: '#fdba74',
      months: '6-8月',
      description: '全國普遍炎熱。南方梅雨季後轉晴熱潮濕，北方乾熱。建議防曬、補水。',
      enabled: false,
    },
    {
      season: 'autumn',
      ...
      iconColor: '#d97706',
      months: '9-11月',
      description: '秋高氣爽，最佳旅遊季節。早晚溫差大，建議攜帶薄外套。',
      enabled: false,
    },
    {
      season: 'winter',
      ...
      iconColor: '#38bdf8',
      months: '12-2月',
      description: '北方嚴寒可達零下 20°C，南方濕冷。必備厚重保暖衣物。',
      enabled: false,
    },
  ],
  infoItems: [
    {
      ...
      icon: 'sim_card',
      title: '網路通訊',
      content: '建議使用國際漫遊或購買中國移動/聯通 SIM 卡。部分地區需實名登記。',
      enabled: false,
    },
    {
      id: 'cn-info-emergency',
      icon: 'emergency',
      iconColor: '#b91c1c',
      title: '緊急聯絡',
      content: '警察 110 / 消防 119 / 急救 120。海基會緊急服務專線：+886-2-2712-9292',
      enabled: false,
    },
  ],
}
...
// 香港 (HK)
// ============================================
const hongKongMemoSettings: MemoSettings = {
  title: '香港旅遊小提醒',
  subtitle: 'Travel Tips',
  headerIcon: 'location_city',
  footerText: '旅遊心得 • 溫馨筆記',
  items: [
    ...
    // 禮儀類
    {
      ...
      title: 'MTR 禮儀',
      titleZh: '地鐵禮儀',
      content: '港鐵車廂內禁止飲食，違者可罰款 HK$2,000。請靠右站立，左側讓給趕時間的乘客。',
      enabled: false,
    },
    {
      id: 'hk-etiquette-2',
      ...
      title: '扶手電梯',
      titleZh: '電扶梯禮儀',
      content: '搭乘電扶梯請靠右站立，左側為超車道。這是香港人非常重視的禮儀。',
      enabled: false,
    },
    {
      id: 'hk-etiquette-3',
      ...
      title: '八達通',
      titleZh: '八達通卡',
      content: '八達通卡可用於交通、便利商店、餐廳等。建議購買或租用，比單程票便宜且便利。',
      enabled: false,
    },
    {
      id: 'hk-etiquette-4',
      ...
      title: '禁煙區域',
      titleZh: '禁煙規定',
      content: '香港大部分室內公共場所禁菸，包括餐廳、商場、車站。違規罰款 HK$1,500。',
      enabled: false,
    },
    // 航空/行李類
    {
      ...
      title: '機場報到',
      titleZh: '報到時間',
      content: '建議起飛前 2.5 ~ 3 小時抵達機場。香港機場很大，請預留步行時間。',
      enabled: false,
    },
    {
      id: 'hk-flight-2',
    ...
    },
    {
      ...
      title: '港幣',
      titleZh: '貨幣兌換',
      content: '香港使用港幣(HKD)。建議在台灣先換少量港幣，當地找換店匯率通常較銀行好。',
      enabled: false,
    },
  ],
  seasons: [
    {
      ...
      iconColor: '#9ca3af',
      months: '3-5月',
      description: '潮濕多霧，氣溫約 20-28°C。建議攜帶薄外套與雨具，室內冷氣強。',
      enabled: false,
    },
    {
      season: 'summer',
      ...
      iconColor: '#fdba74',
      months: '6-9月',
      description: '炎熱潮濕，常有颱風。氣溫可達 33°C。建議透氣衣物、防曬、多補水。',
      enabled: false,
    },
    {
      season: 'autumn',
      ...
      iconColor: '#d97706',
      months: '10-11月',
      description: '秋高氣爽，最佳旅遊季節。氣溫約 20-28°C，舒適宜人。',
      enabled: false,
    },
    {
      season: 'winter',
      ...
      iconColor: '#38bdf8',
      months: '12-2月',
      description: '乾燥涼爽，氣溫約 12-20°C。建議攜帶保暖外套，室內外溫差大。',
      enabled: false,
    },
  ],
  infoItems: [
    {
      ...
      icon: 'wifi',
      title: '網路與通訊',
      content: '香港網路暢通，Google、LINE、Facebook 皆可使用。建議購買當地 SIM 卡或開通漫遊。',
      enabled: false,
    },
    {
      id: 'hk-info-emergency',
      icon: 'emergency',
      iconColor: '#b91c1c',
      title: '緊急聯絡',
      content: '報警/消防/急救統一撥打 999。駐香港台北經濟文化辦事處：+852-2525-8642',
      enabled: false,
    },
  ],
}
...
export function getMemoSettingsByCountry(countryCode: CountryCode): MemoSettings {
  switch (countryCode) {
    ...
    case 'CN':
      return JSON.parse(JSON.stringify(chinaMemoSettings))
    case 'HK':
      return JSON.parse(JSON.stringify(hongKongMemoSettings))
    default:
...
export function getCountryCodeFromName(countryNameOrCode: string): CountryCode {
  ...
  if (['JP', 'TH', 'KR', 'VN', 'CN', 'HK', 'TW', 'GU'].includes(upperInput)) {

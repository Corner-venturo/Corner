...
const DEFAULT_PROHIBITED_ITEMS = [
  { category: '刀類', items: '如各種水果刀、剪刀、菜刀、西瓜刀、生魚片刀、開山刀、鎌刀、美工刀、牛排刀、折疊刀、手術刀、瑞士刀等具有切割功能之器具等\n※ 不含塑膠安全圓頭剪刀及圓頭之奶油餐刀' },
  { category: '尖銳物品類', items: '如弓箭、大型魚鉤、長度超過五公分之金屬釘、飛鏢、金屬毛線針、釘槍、醫療注射針頭等具有穿刺功能之器具' },
  { category: '棍棒、工具類', items: '各種材質之棍棒、鋤頭、鎚子、斧頭、螺絲起子、金屬耙、錐子、鋸子、鑿子、冰鑿、鐵鍊、厚度超過0.5毫米之金屬尺等可做為敲擊、穿刺之器具，金屬游標卡尺' },
  { category: '運動用品類', items: '如棒球棒、高爾夫球桿、曲棍球棍、板球球板、撞球桿、滑板、愛斯基摩划艇和獨木舟划槳、冰球球桿、釣魚竿、彈弓、冰／釘鞋等可能轉變為攻擊性武器之物品' },
  { category: '其他類', items: '攝影類的攝影機與相機腳架或自拍棒。其他經人為操作可能影響飛航安全之物品' },
]

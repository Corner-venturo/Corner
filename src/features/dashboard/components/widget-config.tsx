import { Calculator, DollarSign, Clock, Clipboard, Sparkles, Cloud, Plane, CloudSun, Shield, Banknote } from 'lucide-react';
...
export const AVAILABLE_WIDGETS: WidgetConfig[] = [
  ...
  { id: 'weather-weekly', name: '天氣週報', icon: CloudSun, component: WeatherWidgetWeekly, span: 2 },

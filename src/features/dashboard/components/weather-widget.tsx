                ...
                <div className="hidden sm:flex items-center justify-around gap-2 md:gap-3">
                  ...
                  <div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0">
                      <p className="text-base md:text-lg font-bold text-morandi-primary truncate">
                        {weatherInfo.label}
                      </p>
                  ...
                  <div className="text-center flex-shrink-0 min-w-[60px] md:min-w-[70px]">
                    ...
                    <p className="text-base md:text-lg font-bold text-morandi-primary">
                  ...
                  <div className="text-center flex-shrink-0 min-w-[60px] md:min-w-[70px]">
                    ...
                    <p className="text-sm md:text-base font-bold text-morandi-primary">
                      {weather.windSpeed}
                    </p>
                ...
                <div className="sm:hidden space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="text-center p-3 rounded-lg bg-white/50">
                      ...
                      <p className="text-xl font-bold text-morandi-primary">
                        {weather.temperature}°C
                      </p>
                    </div>
                    <div className="text-center p-3 rounded-lg bg-white/50">

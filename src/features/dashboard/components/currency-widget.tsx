  ...
  const DEFAULT_RATES = useMemo(
    () => ({
      USD: {
        ...
        symbol: '$',
        name: '美金',
        color: 'from-status-info-bg to-cyan-100/60',
        gradient: 'bg-gradient-to-br from-status-info-bg via-white to-cyan-50',
      },
      JPY: {
        rate: 0.21,
        symbol: '¥',
        name: '日幣',
        color: 'from-morandi-red/20 to-pink-100/60',
        gradient: 'bg-gradient-to-br from-status-danger-bg via-white to-pink-50',
      },
      KRW: {
        rate: 0.024,
        symbol: '₩',
        name: '韓元',
        color: 'from-purple-600/30 to-violet-100/60',

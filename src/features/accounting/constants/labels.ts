export const ACCOUNTING_REPORT_LABELS = {
  ...
  PC_MONTH_SUFFIX: '月',
  PC_COL_PERIOD: '期間',
  PC_COL_NET_INCOME: '本期損益',
  PC_COL_CLOSING_TIME: '結轉時間',
  PC_COL_ACCOUNT_CODE: '科目代碼',
  PC_COL_ACCOUNT_NAME: '科目名稱',
  PC_COL_AMOUNT: '金額',
  PC_COL_ENTRY: '結轉分錄',
  PC_DEBIT: '借',
  PC_CREDIT: '貸',
  PC_TOGGLE_HISTORY: '結轉紀錄',
  PC_TOGGLE_CLOSING: '返回結轉',
  PC_NO_RECORDS: '尚無結轉紀錄',
  PC_YEAR_SUFFIX: '年',
  PC_PREVIEW: '預覽結轉',
  PC_ALREADY_CLOSED: '此期間已完成結轉',
  PC_REVENUE: '營業收入',
  PC_COST: '營業成本',
  PC_EXPENSE: '營業費用',
  PC_PROFIT: '盈餘',
  PC_LOSS: '虧損',
  PC_CURRENT_PERIOD_PREFIX: '本期',
  PC_ENTRY_PREVIEW_TITLE: '結轉分錄預覽',
  PC_ENTRY_PREVIEW_DESC: '以下分錄將在確認後自動產生',
  PC_REVENUE_DEBIT: '收入科目（借方結清）',
  PC_COST_CREDIT: '成本科目（貸方結清）',
  PC_EXPENSE_CREDIT: '費用科目（貸方結清）',
  PC_NO_BALANCE: '此期間無損益科目餘額',
  PC_CONFIRM_CLOSING: '確認結轉',
  PC_EMPTY: '選擇期間並點擊「預覽結轉」',
}

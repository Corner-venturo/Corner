...
import { Loader2, UtensilsCrossed, Sun, Cloud, Moon } from 'lucide-react'
...
export function ImportMealsDialog({
  isOpen,
  onClose,
  meals,
  onImport,
}: ImportMealsDialogProps) {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-[var(--morandi-secondary)]">
                            {meal.type}
                          </div>
                        </div>
                      </button>

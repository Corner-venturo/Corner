              ...
              <div className="flex items-start justify-between mb-1.5">
                ...
                <div className="text-right">
                  <div className="inline-block bg-[#FAF8F5] rounded-xl px-3 py-1.5 border border-[#C9A961]/20">
                    <p className="text-[#C9A961] text-[9px] mb-0.5 tracking-widest uppercase">Quotation</p>
              ...
              <div className="bg-[#FAF8F5] rounded-xl p-1.5">
                ...
                <div className="space-y-1">
                  <div>
                    ...
                    <p className="text-[#3D2914] text-[10px] font-medium border-b border-dotted border-gray-300 pb-0.5">　</p>
                  </div>
                  <div>
              ...
              <div className="bg-gradient-to-br from-[#C9A961]/5 to-[#C9A961]/10 rounded-xl p-1.5 border border-[#C9A961]/20">
                ...
                <div className="pt-1.5 border-t border-[#C9A961]/20">
                  <div className="flex items-center gap-1">
                    ...
                    <p className="text-[#8B7355] text-[9px]">報價有效至 {new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toLocaleDateString('zh-TW')}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                <div className="flex items-center gap-1 mb-1">
                  <div className="w-5 h-5 rounded-lg bg-[#C9A961]/10 flex items-center justify-center">
                    <svg className="w-3 h-3 text-[#C9A961]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              ...
              <div>
                <div className="flex items-center gap-1 mb-1">
                  <div className="w-5 h-5 rounded-lg bg-[#3D2914]/5 flex items-center justify-center">
                    <svg className="w-3 h-3 text-[#8B7355]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <div className="bg-[#FAF8F5] rounded-xl p-1.5 border-l-4 border-[#C9A961] mb-1.5">
              ...
              <div className="space-y-0.5">
                ...
                <div className="flex items-start gap-1">
                  ...
                  <p className="text-[#3D2914] text-[9px]">行程內容可能因天候、交通等因素彈性調整</p>
                </div>
                <div className="flex items-start gap-1">
                ...
                <div className="flex items-start gap-1">
                  ...
                  <p className="text-[#3D2914] text-[9px]">付款方式：訂金 30%，出發前 7 天付清尾款</p>
                </div>
              </div>
            </div>

    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* 其他城市選擇（多選） */}
          {formData.country_id && formData.main_city_id && availableCities.filter(city => city.id !== formData.main_city_id).length > 0 && (
            <div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() => {
                              setFormField('other_city_ids', formData.other_city_ids.filter(id => id !== cityId));
                            }}
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => setFormField('status', value)}
            >
              <SelectTrigger className="mt-1">
                <SelectValue />
              </SelectTrigger>

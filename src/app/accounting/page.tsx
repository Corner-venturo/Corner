...
export default function AccountingPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'transactions' | 'accounts' | 'settings'>(
    'overview'
  )
  ...
  return (
    <div className={cn('min-h-screen pb-20 pt-4', currentTheme.bg)}>
      {/* APP風格頂部區域 */}
      <div
        className={cn('text-white p-4 sm:p-6 mx-4 rounded-3xl shadow-lg', currentTheme.headerBg)}
      >
        ...
        <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-4 sm:p-6 mb-4">
          <div className="text-center">
            ...
            <div className="text-xs text-white/60 mt-2">距離月底還有 {daysToEndOfMonth} 天</div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 mt-4 space-y-6">
        ...
        >
          <div className="flex items-center space-x-2 mb-6">
            <Zap
              className={cn('w-5 h-5', theme === 'morandi' ? 'text-[#B5986A]' : 'text-blue-400')}
            />
          ...
          <div className="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-3 mb-6">
            ...
            <div className="sm:col-span-1">
              <div
                className={cn(
                  'rounded-xl border-2 p-4 h-20 transition-colors',
                  theme === 'morandi'
                    ? 'bg-white border-morandi-gold/20 focus-within:border-morandi-gold/20'
                    : 'bg-slate-700 border-slate-500 focus-within:border-blue-400'
                )}
              >
                ...
                <input
                  ...
                  placeholder="0"
                  className={cn(
                    'w-full text-xl font-bold bg-transparent border-0 focus:outline-none',
            ...
            <div className="sm:col-span-1">
              <Select value={quickCategory} onValueChange={setQuickCategory}>
                <SelectTrigger
                  ...
                  className={cn(
                    'h-20 border-2 rounded-xl text-center',
                    theme === 'morandi'
            ...
            <div className="sm:col-span-1">
              <Button
                ...
                className={cn(
                  'w-full h-20 text-white font-semibold rounded-xl border-0 shadow-lg transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:active:scale-100 text-base',
                  currentTheme.accent
                )}
              >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    quickCategory === category.id
                      ? theme === 'morandi'
                        ? 'bg-[#B5986A] text-white shadow-lg'
                        : 'bg-blue-600 text-white shadow-lg'
                      : theme === 'morandi'
                        ? 'bg-white/80 text-[#6B5B73] hover:bg-white border border-morandi-gold/20'
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <Button
              ...
              className={cn(
                ...
                theme === 'morandi'
                  ? 'text-[#B5986A] hover:bg-[#B5986A]/10'
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      theme === 'morandi'
                        ? 'bg-white/60 border-morandi-gold/20'
                        : 'bg-slate-700 border-slate-600'
                    )}
                  >
                    <div className="flex items-center space-x-3 flex-1 min-w-0">
                      <div className="min-w-0 flex-1">
                        <div className={cn('font-medium truncate', currentTheme.primary)}>
                    ...
                    <div className="flex items-center space-x-2 flex-shrink-0">
                      ...
                      <Button
                        ...
                        className={cn(
                          'p-1 sm:p-2',
                          theme === 'morandi'
                            ? 'text-[#6B5B73]/40 hover:text-[#6B5B73]'
        ...
        {activeTab !== 'overview' && (
          <div
            className={cn('rounded-2xl shadow-lg border', currentTheme.cardBg, currentTheme.border)}
          >
      ...
      <div
        className={cn(
          'fixed bottom-0 left-0 right-0 backdrop-blur-lg border-t px-2 sm:px-4 py-2 sm:py-3 safe-area-bottom',
          theme === 'morandi'
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  activeTab === tab.id
                    ? theme === 'morandi'
                      ? 'text-[#B5986A] bg-[#B5986A]/10 scale-110'
                      : 'text-blue-400 bg-blue-400/10 scale-110'
                    : theme === 'morandi'
                      ? 'text-[#6B5B73]/60 hover:text-[#6B5B73] hover:bg-[#6B5B73]/5'

...
export default function LoginPage() {
  ...
  const handleDeleteProfile = (e: React.MouseEvent, profileId: string) => {
    ...
    if (
      confirm(`確定要移除「${profile.display_name}」的角色卡嗎？\n\n移除後需要重新從網路登入。`)
    ) {
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-morandi-secondary">
                        {card.english_name} · {card.role}
                      </div>
                    </div>
                    <LogIn
                      size={18}
                      className="text-morandi-secondary group-hover:text-morandi-gold"
                    />
                  </button>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-morandi-secondary">
                      {selectedProfile.english_name} · {selectedProfile.role}
                    </div>
                  </div>
                </div>
              </div>

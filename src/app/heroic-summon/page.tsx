...
import {
  ...
  getQuestionById,
  calculateProgress,
} from '@/data/heroic-summon-questions'
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 text-center">
              ...
              <p className="text-morandi-secondary mb-8 max-w-2xl mx-auto">
                透過 120 題精心設計的問題，探索你內在的靈魂原型。 測驗分為 6
                個階段，每個階段深入挖掘你不同面向的特質。
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-8">
                {PHASES.map(phase => (
                  ...
                  >
                    ...
                    <p className="text-sm text-morandi-secondary">{phase.description}</p>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 text-center">
              ...
              <div className="bg-morandi-container/30 rounded-lg p-6 mb-8">
                <p className="text-sm text-morandi-secondary">測驗結果分析功能開發中...</p>
              </div>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-morandi-secondary">第 {currentPhase} 階段 / 共 6 階段</p>
              </div>
              <div className="text-right">
                <p className="text-2xl font-bold text-morandi-gold">{progress}%</p>
                <p className="text-xs text-morandi-secondary">{totalAnswered} / 120 題</p>
              </div>
            </div>

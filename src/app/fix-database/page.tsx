    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-morandi-secondary">自動檢測並修復 IndexedDB 相關問題</p>
        </div>
            ...
            {issues.map(issue => (
              ...
              >
                <div>
                  ...
                  {issue.error && <div className="text-sm text-red-600 mt-1">{issue.error}</div>}
                </div>
                <div>
        ...
        <div className="flex gap-3 mb-6">
          <Button onClick={fixDatabase} disabled={isFixing} className="flex-1">
            {isFixing ? (
              <>
          ...
          <Button variant="destructive" onClick={clearDatabase} disabled={isFixing}>
            完全重置資料庫
          </Button>
        </div>

        ...
        <div className="space-y-6">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-semibold text-gray-800">主要顯示圖片</h3>
            </div>
            <div className="flex gap-4">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-700">圖片 1</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="radio"
                  ...
                  className="w-4 h-4 text-amber-600"
                />
                <span className="text-sm text-gray-700">圖片 2</span>
              </label>
            </div>
            <p className="text-xs text-gray-600 mt-2">主要圖片會在行程封面和城市列表中顯示</p>
          </div>

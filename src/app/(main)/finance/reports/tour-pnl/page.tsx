...
export default function TourPnLPage() {
  ...
  const columns: TableColumn<TourPnL>[] = [
    ...
    {
      key: 'departure_date',
      label: TOUR_PNL_LABELS.COL_DEPARTURE_DATE,
      sortable: true,
      render: value => <DateCell date={value as string} />,
    },
    {
      key: 'max_participants',
      label: TOUR_PNL_LABELS.COL_PARTICIPANTS,
      sortable: true,
      align: 'center',
    },
    {
    ...
    {
      key: 'total_revenue',
      label: TOUR_PNL_LABELS.COL_REVENUE,
      sortable: true,
      align: 'right',
    ...
    {
      key: 'total_cost',
      label: TOUR_PNL_LABELS.COL_COST,
      sortable: true,
      align: 'right',
    ...
    },
    {
      ...
      render: value => {
        ...
        return (
          <span
            className={
              n < 0 ? 'text-status-danger font-semibold' : 'text-status-success font-semibold'
            }
          >
    ...
    },
    {
      ...
      render: value => {
        ...
        return (
          <span
            className={
              n < 0 ? 'text-status-danger' : n < 10 ? 'text-status-warning' : 'text-status-success'
            }
          >
            {n}%
          </span>
      ...
      headerActions={
        <div className="flex items-center gap-3 flex-wrap">
          <div className="flex gap-2 text-sm">
            ...
            <span
              className={`font-semibold ${summary.totalProfit < 0 ? 'text-status-danger' : 'text-status-success'}`}
            >

...
export default function PaymentsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      label: '說明',
      sortable: false,
      render: (value: string) => <div className="text-sm text-morandi-primary">{value}</div>,
    },
    {
      key: 'order_id',
      label: '訂單編號',
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            updatePaymentItem(item.id, { paymentMethod: value })
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          value={item.amount || ''}
                          onChange={e =>
                            updatePaymentItem(item.id, { amount: Number(e.target.value) })
                          }
                          placeholder="請輸入收款金額"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            updatePaymentItem(item.id, { transactionDate: e.target.value })
                          }
                        />
                      </div>
                      ...
                      {item.paymentMethod === '現金' && (
                        <div>
                          ...
                          <Input
                            ...
                            onChange={e =>
                              updatePaymentItem(item.id, { handlerName: e.target.value })
                            }
                        ...
                        <>
                          <div>
                            ...
                            <Select
                              ...
                              onValueChange={value =>
                                updatePaymentItem(item.id, { accountInfo: value })
                              }
                            >
                              <SelectTrigger>
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              value={item.fees || ''}
                              onChange={e =>
                                updatePaymentItem(item.id, { fees: Number(e.target.value) })
                              }
                              placeholder="手續費金額"
                            />
                          </div>
                        ...
                        <>
                          <div>
                            ...
                            <Input
                              ...
                              onChange={e =>
                                updatePaymentItem(item.id, { cardLastFour: e.target.value })
                              }
                              placeholder="****"
                              maxLength={4}
                            />
                          ...
                          <div>
                            ...
                            <Input
                              value={item.authCode || ''}
                              onChange={e =>
                                updatePaymentItem(item.id, { authCode: e.target.value })
                              }
                              placeholder="授權碼"
                            />
                          </div>
                        ...
                        <>
                          <div>
                            ...
                            <Input
                              ...
                              onChange={e =>
                                updatePaymentItem(item.id, { checkNumber: e.target.value })
                              }
                              placeholder="支票號碼"
                            />
                          </div>
                          <div>
                            ...
                            <Input
                              ...
                              onChange={e =>
                                updatePaymentItem(item.id, { checkBank: e.target.value })
                              }
                              placeholder="開票銀行"
                            />
                          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    value={
                      selectedOrder
                        ? total_amount >= (selectedOrder.remaining_amount || 0)
                          ? '已收款'
                          : '部分收款'
                        : '請選擇訂單'
                    }

...
export default function DayTimeGrid({ selectedDay, timeInterval }: DayTimeGridProps) {
      ...
      <div className="grid grid-cols-2">
        <div className="border-r border-border bg-morandi-container/10">
          {timeSlots.map((timeSlot, index) => (
            <div
              key={timeSlot}
              className={`${slotClass} flex items-center justify-center text-sm text-morandi-secondary border-b border-border/50`}

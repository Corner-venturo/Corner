...
export const QuickActionMenu = forwardRef<HTMLDivElement, QuickActionMenuProps>(
  function QuickActionMenu({ isOpen, actions }, ref) {
    ...
    return (
      <div
        ref={ref}
        className="absolute bottom-full left-0 mb-2 bg-card border border-morandi-gold/20 rounded-lg shadow-lg py-1.5 min-w-[220px] z-50 animate-in fade-in slide-in-from-bottom-2 duration-200"
      >

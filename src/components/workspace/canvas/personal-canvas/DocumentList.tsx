...
function EmptyDocumentState({ searchTerm, selectedTag, onCreateDocument }: EmptyDocumentStateProps) {
...
function DocumentCard({ document, viewMode, onView, onEdit, onDelete, onToggleFavorite }: DocumentCardProps) {
  return (
    <div
      className={cn(

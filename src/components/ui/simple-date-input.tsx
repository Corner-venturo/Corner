...
export function SimpleDateInput({
  ...
  // 格式化顯示文字
  const displayText = value && isValid(dateValue) ? format(dateValue, 'yyyy/MM/dd') : ''
  ...
  return (
    <div className={cn('relative', className)}>
      <div className="flex items-center gap-3 h-10 w-full rounded-md border border-input bg-background px-3 text-sm focus-within:border-morandi-gold transition-colors">
        {/* 顯示模式：已選擇日期 */}
        {displayText ? (
          <>

...
interface DestinationSelectorProps {
  ...
  onCountryChange: (countryCode: string, cities: Array<{ id: string; code: string; name: string }>) => void;
...
export function DestinationSelector({
  ...
  const handleCountryChange = (selectedCountryCode: string) => {
    ...
    const cities = selectedCountryCode === '__custom__' ? [] : (selectedCountry ? getCitiesByCountryId(selectedCountry.id) : []);

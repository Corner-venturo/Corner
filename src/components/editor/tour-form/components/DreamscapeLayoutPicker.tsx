...
const layoutOptions: {
...
}[] = [
  {
    ...
    label: COMP_EDITOR_LABELS.Blob_左,
    color: '#9370db',
  },
  {
    value: 'blobRight',
    icon: <LayoutPanelLeft size={16} />,
    label: COMP_EDITOR_LABELS.Blob_右,
    color: '#ff7f50',
  },
  {
    value: 'fullHero',
    icon: <ImageIcon size={16} />,
    label: COMP_EDITOR_LABELS.全幅英雄,
    color: '#4a6fa5',
  },
  {
    value: 'glassCard',
    icon: <Layers size={16} />,
    label: COMP_EDITOR_LABELS.玻璃卡片,
    color: '#8da399',
  },
]
        ...
        {layoutOptions.map(option => (
          <button
            ...
            className={`flex items-center gap-1.5 px-2 py-1 rounded-md text-xs transition-all ${
              currentLayout === option.value ? 'bg-card shadow-sm' : 'hover:bg-card/50'
            }`}
            style={{

...
const STYLE_OPTIONS: { value: ItineraryStyle; label: string; icon: string; description: string }[] = [
  { value: 'relax', label: '悠閒慢活', icon: '🌿', description: '放慢腳步，每天 2-3 個景點' },
  { value: 'adventure', label: '冒險探索', icon: '🏔️', description: '深度體驗，探索隱藏景點' },
  { value: 'culture', label: '文化巡禮', icon: '🏛️', description: '歷史古蹟、博物館為主' },
  { value: 'food', label: '美食之旅', icon: '🍜', description: '在地美食、市場巡禮' },
]
      ...
      <DialogContent level={1} className="sm:max-w-lg">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-morandi-secondary">
              指定住宿城市可讓行程更精準。例如：大阪進但住京都，會優先安排京都景點。
            </p>
                  ...
                  <div key={index} className="flex items-center gap-2 p-2 bg-muted rounded-lg">
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-sm text-morandi-secondary">晚</span>
                      </div>
                    </div>
                    <Button
                      type="button"

...
const STYLE_OPTIONS: { value: ItineraryStyle; label: string; icon: string; description: string }[] = [
  { value: 'relax', label: COMP_EDITOR_LABELS.悠閒慢活, icon: '🌿', description: COMP_EDITOR_LABELS.放慢腳步_每天_2_3_個景點 },
  { value: 'adventure', label: COMP_EDITOR_LABELS.冒險探索, icon: '🏔️', description: COMP_EDITOR_LABELS.深度體驗_探索隱藏景點 },
  { value: 'culture', label: COMP_EDITOR_LABELS.文化巡禮, icon: '🏛️', description: COMP_EDITOR_LABELS.歷史古蹟_博物館為主 },
  { value: 'food', label: COMP_EDITOR_LABELS.美食之旅, icon: '🍜', description: COMP_EDITOR_LABELS.在地美食_市場巡禮 },
]
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={cityId} onValueChange={setCityId}>
              <SelectTrigger>
                <SelectValue placeholder={citiesLoading ? COMP_EDITOR_LABELS.載入中 : COMP_EDITOR_LABELS.選擇城市} />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-morandi-secondary">
              {COMP_EDITOR_LABELS.EXAMPLE_7314}
            </p>
                  ...
                  <div key={index} className="flex items-center gap-2 p-2 bg-muted rounded-lg">
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-sm text-morandi-secondary">{COMP_EDITOR_LABELS.LABEL_7570}</span>
                      </div>
                    </div>
                    <Button
                      type="button"

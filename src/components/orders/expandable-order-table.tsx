...
export const ExpandableOrderTable = React.memo(function ExpandableOrderTable({
  orders,
  showTourInfo = false,
  tourDepartureDate,
  className,
        ...
        <table className="w-full">
          ...
          <tbody>
            {orders.length === 0 ? (
              <>
                <tr>
                  <td className="py-1.5 sm:py-2 px-3 sm:px-4 text-center text-morandi-secondary/50">
                    -
                  </td>
                  {showTourInfo && (
                    <td className="py-1.5 sm:py-2 px-3 sm:px-4 text-center text-morandi-secondary/50">
                ...
                <tr>
                  <td colSpan={showTourInfo ? 6 : 5} className="py-8"></td>
                </tr>
              </>
            ) : (
                ...
                <React.Fragment key={order.id}>
                  ...
                  >
                    <td className="py-1.5 sm:py-2 px-3 sm:px-4">
                      <div className="text-[10px] sm:text-xs font-medium text-morandi-primary">
                        {order.order_number}
                      </div>
                    </td>

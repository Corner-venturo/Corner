...
interface MemberAssignmentPanelProps {
  ...
  filteredUnassignedMembers: OrderMember[]
  memberFilter: string
  ...
  onAssignMember: (roomId: string, memberId: string, members: OrderMember[], rooms: TourRoomStatus[], assignments: TourRoomAssignment[]) => void
}
                  ...
                  {availableRooms.map(room => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => onAssignMember(room.id, member.id, members, rooms, assignments)}

                ...
                <input
                  ...
                  onChange={e => {
                    if (e.target.checked) {
                      ...
                      setFormData({
                        ...formData,
                        roles: formData.roles.filter(r => r !== 'employee'),
                      })
                    }
                  }}
                  className="w-4 h-4 text-morandi-gold focus:ring-morandi-gold rounded"
                ...
                <input
                  ...
                  onChange={e => {
                    if (e.target.checked) {
                      ...
                      setFormData({
                        ...formData,
                        roles: formData.roles.filter(r => r !== 'tour_leader'),
                      })
                    }
                  }}
                  className="w-4 h-4 text-morandi-gold focus:ring-morandi-gold rounded"
                ...
                <input
                  ...
                  onChange={e => {
                    if (e.target.checked) {
                      ...
                      setFormData({
                        ...formData,
                        roles: formData.roles.filter(r => r !== 'accountant'),
                      })
                    }
                  }}
                  className="w-4 h-4 text-morandi-gold focus:ring-morandi-gold rounded"
                ...
                <input
                  ...
                  onChange={e => {
                    if (e.target.checked) {
                      ...
                      setFormData({
                        ...formData,
                        roles: formData.roles.filter(r => r !== 'assistant'),
                      })
                    }
                  }}
                  className="w-4 h-4 text-morandi-gold focus:ring-morandi-gold rounded"
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(createdEmployee?.employee_number || '', 'number')
                      }

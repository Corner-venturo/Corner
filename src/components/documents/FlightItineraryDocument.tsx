...
export const FlightItineraryDocument = forwardRef<
  HTMLDivElement,
  FlightItineraryDocumentProps
          ...
          <div key={idx} className="baggage-detail-section">
            ...
            <ul className="baggage-detail-list">
              {baggage.carryOn.dimensions && (
                <li>
                  <strong>手提行李:</strong> 每人 {baggage.carryOn.pieces} 件，
                  每件 {baggage.carryOn.weight} 公斤 每件尺寸上限 {baggage.carryOn.dimensions}
                </li>
              )}

              {baggage.checked.dimensions && (
                <li>
                  <strong>託運行李:</strong> 每人 {baggage.checked.pieces} 件，
                  每件 {baggage.checked.weight} 公斤 每件尺寸 {baggage.checked.dimensions}
                </li>
              )}

              <li>
                <strong>個人物品:</strong> {baggage.personalItem} 請聯繫航空公司以進一步了解行李政策
                必須置於您前面座位的下方。
              </li>
            </ul>
          </div>
